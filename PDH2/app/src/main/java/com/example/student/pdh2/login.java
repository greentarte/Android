package com.example.student.pdh2;
...
<pre style="font-family: 굴림체; font-size: 9pt;">    EditText edit_id, edit_pw;</pre><pre style="font-family: 굴림체; font-size: 9pt;">    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_login); </pre><pre style="font-family: 굴림체; font-size: 9pt;">//layout_login.xml를 사용합니다.
                edit_id = (EditText) findViewById(R.id.login_id);</pre><pre style="font-family: 굴림체; font-size: 9pt;">//edit_id변수와 xml에 id입력 부분을 연결합니다.
                edit_pw = (EditText) findViewById(R.id.login_pw);</pre><pre style="font-family: 굴림체; font-size: 9pt;">//edit_pw변수와 xml에 pw입력 부분을 연결합니다.
    }

    public void join_btn(View view) {</pre><pre style="font-family: 굴림체; font-size: 9pt;">//여기는 제가 회원가입창을 만든 부분이라서 생략하셔도 됩니다.</pre><pre style="font-family: 굴림체; font-size: 9pt;">//짧게 intent속성 설명을 드리면.
            Intent intent = new Intent(login.this, join.class);</pre><pre style="font-family: 굴림체; font-size: 9pt;"><pre style="font-size: 9pt; font-family: 굴림체;">//intent를 생성합니다. intent(현재class, 이동할 class) 단, MainActivity는 그냥 this만 쓰셔도 됩니다.</pre>
            startActivity(intent);

//인텐트 시작.~
        finish();

//인텐트 종료~, 인텐트는 이동해도 그전 class가 켜져있으므로 꺼줍니다.
    }
...
[출처] [Android Studio] 안드로이드-jsp-db를 연결하여 간단한 로그인 구현.|작성자 abcdtyy456
